package nl.juraji.biliomi.components.integrations.autoupdates;
...
import nl.juraji.biliomi.components.integrations.autoupdates.github.api.v3.GithubApi;
import nl.juraji.biliomi.components.integrations.autoupdates.github.api.v3.model.GithubRelease;
import nl.juraji.biliomi.components.integrations.autoupdates.github.api.v3.model.GithubReleaseAsset;
...
public class FindUpdatesSetupTask implements SetupTask {
    ...
    public void update() {
        ...
        try {
            Response<GithubRelease> response = githubApi.getLatestRelease(GH_REPO_OWNER, GH_REPO_NAME);
