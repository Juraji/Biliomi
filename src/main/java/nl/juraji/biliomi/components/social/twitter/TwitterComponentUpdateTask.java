...
import static nl.juraji.biliomi.components.social.twitter.TwitterComponent.TWITTER_TWEET_FOUND_TEMPLATE_ID;
import static nl.juraji.biliomi.components.social.twitter.TwitterComponent.TWITTER_UPDATE_TEMPLATE_ID;
...
public class TwitterComponentUpdateTask implements SetupTask {
  ...
  @Override
  public void install() {
    if (!templateDao.templateExists(TWITTER_UPDATE_TEMPLATE_ID)) {
      Template template = new Template();
      template.setTemplateKey(TWITTER_UPDATE_TEMPLATE_ID);
    ...
    if (!templateDao.templateExists(TWITTER_TWEET_FOUND_TEMPLATE_ID)) {
      Template template = new Template();
      template.setTemplateKey(TWITTER_TWEET_FOUND_TEMPLATE_ID);
