...
import static nl.juraji.biliomi.components.games.tamagotchi.services.TamagotchiConstants.MOOD_BORED_THRESHOLD;
import static nl.juraji.biliomi.components.games.tamagotchi.services.TamagotchiConstants.MOOD_SAD_THRESHOLD;
...
public class TamagotchiService {
  ...
  public String getMoodText(Tamagotchi tamagotchi) {
    ...
    if (moodPercentage < MOOD_SAD_THRESHOLD) {
      templater = l10n.get("Common.tamagotchi.mood.sad");
    } else if (moodPercentage < MOOD_BORED_THRESHOLD) {
  ...
  public String getHygieneState(Tamagotchi tamagotchi) {
    ...
    if (hygienePercentage < MOOD_SAD_THRESHOLD) {
      templater = l10n.get("Common.tamagotchi.hygieneState.filthy");
    } else if (hygienePercentage < MOOD_BORED_THRESHOLD) {
