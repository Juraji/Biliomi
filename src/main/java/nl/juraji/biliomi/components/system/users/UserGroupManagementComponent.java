...
import static nl.juraji.biliomi.components.system.users.UserGroupService.MAX_WEIGHT;
import static nl.juraji.biliomi.components.system.users.UserGroupService.MIN_WEIGHT;
...
public class UserGroupManagementComponent extends Component {
  ...
  private boolean editUserGroupWeight(User user, UserGroup targetUserGroup, String newWeightString) {
    ...
    if (newGroupWeight == null || MathUtils.isNotInRange(newGroupWeight, MIN_WEIGHT, MAX_WEIGHT)) {
      chat.whisper(user, l10n.get("ChatCommand.groups.help"));
      return false;
    }
